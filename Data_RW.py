...
def get_raw_data(N, L, g, OR=10, sub_dir="cosmhol-hbor"):
    ...
    for m in masses:
        ...
        phi2[m] = numpy.fromtxt(f"{in_dir}/{file_prefix}_phi2.0.dat")
        m2[m] = numpy.fromtxt(f"{in_dir}/{file_prefix}_m2.0.dat")
        m4[m] = numpy.fromtxt(f"{in_dir}/{file_prefix}_m4.0.dat")
